...
```
# For Bitcoin Cash
conan install bitprim-node-exe/0.11.0@bitprim/stable -o currency=BCH 
# ... or (BCH is the default crypto)
conan install bitprim-node-exe/0.11.0@bitprim/stable 

# For Bitcoin Legacy
conan install bitprim-node-exe/0.11.0@bitprim/stable -o currency=BTC

# For Litecoin
conan install bitprim-node-exe/0.11.0@bitprim/stable -o currency=LTC
```
...
conan install bitprim-node-exe/0.11.0@bitprim/stable -o currency=BCH -o microarchitecture=haswell 
```
